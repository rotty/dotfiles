...
mytextbox.text = "<b><small> " .. "FIXME" .. " </small></b>"

-- Theme handling
theme_path = awful.util.getdir("config") .. "/themes/current_theme/theme.lua"

-- Actually load theme
beautiful.init(theme_path)

-- Automatic theme menu, reloaded on start
mythememenu = {}
...
function theme_load(theme)
   ...
   awful.util.spawn("ln -sf " .. theme .. " " .. cfg_path .. "/current_theme")
   awesome.restart()
end
...
globalkeys =
{
    key({ modkey,           }, ",",      awful.tag.viewprev       ),
    key({ modkey,           }, ".",      awful.tag.viewnext       ),
    ...
    -- Layout manipulation
    key({ modkey, "Shift"   }, "Down", function () awful.client.swap.byidx(  1) end),
    key({ modkey, "Shift"   }, "Up",   function () awful.client.swap.byidx( -1) end),
    key({ modkey, "Control" }, "Down", function () awful.screen.focus( 1)       end),
    key({ modkey, "Control" }, "Up",   function () awful.screen.focus(-1)       end),
...
clientkeys =
{
    ...
    key({ modkey,           }, "Return", function (c) c:swap(awful.client.getmaster()) end),
